...
public class Crosswork extends JApplet {
    ...
    public void initComponents() {
        ...
        class XWordCellRenderer extends DefaultListCellRenderer {
            public Component getListCellRendererComponent(JList<? extends XWord> list, XWord value, int index,
        ...
        statusLabel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED),
